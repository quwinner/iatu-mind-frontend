...
// Custom Hooks
// import { useSetUser, useUser } from '../../../hook/useUser'
...
const Profile: FC<Props> = () => {
  ...
  //       <Link to="/signin" className="profile-header-signin link"></Link>
  //     </div>
  //   )
      ...
      <div className={cn('profile-header-tip', { active: state })}>
        <div className={cn('profile-header-tip__header', { active: state })}>
          <div className="profile-header-tip__avatar avatar-content">
            ...
            <div className="avatar-content__front">
              {/* {userInfo.avatarUrl !== null ? (
                <img src={userInfo.avatarUrl} alt="nope"></img>
              ) : ( */}
              <img
          ...
          <div className="profile-header-tip__info info-content">
            <div className="info-content__nickname">{2134}</div>
            <div className="info-content__steamid">{432}</div>
          </div>
        </div>
        <Link
